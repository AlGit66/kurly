        ...
        return (
            <div id='kurly'>
                <form onSubmit={this.onSubmitEvent} id='form'>
                    <div className='title'>
                        <h1><img src='https://AlGit66.github.io/kurly/img/logo_x2.png' alt='logo'/></h1>
                        <h2>회원가입</h2>
                    </div>
                        ...
                        <li>
                            <div className='gap'>
                                ...
                                <div className='input-box'>
                                {
                                    ...
                                    `} 
                                    id='inputAddress'>
                                        <img src='https://AlGit66.github.io/kurly/img/_ico_search.svg' alt='검색'/>
                                        <span>
                                        {
                                ...
                                <div className='content-box'>
                                    <ul>
                                        <li>
                                            <h2>알림메시지</h2>
                                            <span>
                                                <a href='#!' onClick={this.onClickModalClose} title='Close'><img src='https://AlGit66.github.io/kurly/img/ico_close_999_32x32.png' alt=''/></a>
                                            </span>
                                        </li>
                                        <li>
